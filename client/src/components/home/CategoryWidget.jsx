              ...
              {data.categories.map((category) => (
                <li key={category.documentId} className="mb-1 text-[25px] text-sky-700"> {/* Each item is now a proper <li> */}
                  <div className="flex flex-col w-[70%]">
                    <Link href={`/category/${category.documentId}`} className={`text-[14px] font-semibold  hover:tracking-[1px] transition-all duration-500  font-montserrat text-gray-500 hover:text-sky-500 hover:font-semibold}`}>
