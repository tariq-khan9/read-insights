...
<div className=' bg-slate-500  bg-opacity-40 w-full my-16 relative rounded-xl'>
       ...
       <div className='p-10 flex flex-col justify-center items-center space-y-2'>
         ...
         <h1 className='text-[14px] text-slate-100 font-montserrat font-extralight'>{author.userBio}</h1>
